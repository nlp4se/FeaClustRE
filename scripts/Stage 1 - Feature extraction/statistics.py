...
def process_files(input_folder, output_folder):
    ...
    for filename in os.listdir(input_folder):
        ...
        # Get top 50 most common verbs and nouns
        top_verbs = Counter(verbs).most_common(50)
        top_nouns = Counter(nouns).most_common(50)
        ...
        plt.title(f'Verb-Noun Heatmap for {base_name}')
        plt.tight_layout()
